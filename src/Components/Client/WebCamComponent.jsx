  ...
  return (
    <div style={{display:"flex",justifyContent:"center",height:"88.46vh"}} className="body" >
      <div className="webcam-container">
        {(webcamControl)?<Webcam mirrored={true} videoConstraints={videoConstraints} style={{borderRadius: "20px"}}/>:<div className="camera-off-text"><img style={{position:"absolute",width: "100%",height: "100%", borderRadius:"20px"}} src={image}/></div>}
